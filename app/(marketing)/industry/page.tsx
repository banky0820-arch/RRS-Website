...
export default function IndustryPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden py-32 min-h-[480px] flex items-center" aria-labelledby="industry-hero-heading">
        <Image
          src="/industry-hero.jpg"
          alt=""
          fill
          priority
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(10,22,40,0.88) 0%, rgba(6,16,30,0.70) 100%)' }}
          aria-hidden="true"
        />
